...
(function() {
   ...
   jQuery('.custom-nav > li').click(function(){  
      $(this).children(".child_li").show()
      $(this).siblings().children(".child_li").hide()
   });

   // 二级菜单的滚动条定位
   jQuery('.custom-nav .child_li').click(function(){
      var data_id = $(this).attr('data_id');
      if(data_id==='2'){
         $("#iframeId")[0].contentWindow.scrollTo(100, 440)
      }else if(data_id==='3'){
         $("#iframeId")[0].contentWindow.scrollTo(100, 895)
      }else if(data_id==='5'){
         $("#iframeId")[0].contentWindow.scrollTo(100, 475)
      }else if(data_id==='6'){
         $("#iframeId")[0].contentWindow.scrollTo(100, 940)
      }else{
         $("#iframeId")[0].contentWindow.scrollTo(100, 0)
      }
   });
